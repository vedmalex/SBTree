...
const lowerThanKeys_1 = __importDefault(require("./ops/lowerThanKeys"));
const greaterThanKeys_1 = __importDefault(require("./ops/greaterThanKeys"));
    ...
    switch (op) {
        ...
        case '$lt':
            if (firstIdx > -1) {
                ...
                const ltKeys = lowerThanKeys_1.default(keys, value);
        ...
        case '$gt':
            if (firstIdx > -1) {
                ...
                const gtKeys = greaterThanKeys_1.default(keys, value);
