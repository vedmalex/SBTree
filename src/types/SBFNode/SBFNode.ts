...
export class SBFNode {
  ...
  getTree(): SBFTree {
    return (
      (this.parent as SBFRoot).getTree() ||
      (this.parent as SBFNode).getParent().getTree()
    )
  }
  getAdapter() {
  ...
  async insertReferenceKey(value) {
    return insertReferenceKey.call(this, value) as ReturnType<
      typeof insertReferenceKey
    >
  }
  isFull() {
